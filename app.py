...
def main():
    ...
    with tab2:
        ...
        if submitted:
            ...
            # HIGH severity flags — any single one forces HIGH RISK immediately
            ...
            # ALL suspicious flags (excluding OC/CC which is protective)
            ...
            with r2:
                # --- Model score chip (always reflects the raw ML output) ---
                if score >= 0.7:
                    score_color = "#f87171"
                ...
                # --- Final verdict (can be escalated by flags) ---
                if score >= 0.7 or critical_flags_triggered >= 1:
                    ...
                    if critical_flags_triggered >= 1 and score < 0.7:
                        action = f"Critical document flag triggered — send to fraud investigation team"
                    else:
